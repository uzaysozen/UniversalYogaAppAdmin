...
public class CourseList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CourseAdapter classAdapter = new CourseAdapter(getApplicationContext(), result_uzay);
        lv.setAdapter(classAdapter);

        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent classDatePage = new Intent(CourseList.this, CreateClassInstance.class);
        ...
        create.setOnClickListener(v -> {
            Intent createCoursePage = new Intent(CourseList.this, CreateCourse.class);
